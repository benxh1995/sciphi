...
- [Cognitive Neuroscience: A Comprehensive Guide](#Cognitive-Neuroscience:-A-Comprehensive-Guide)
  ...
  - [Chapter: Attention and Mental Processes](#Chapter:-Attention-and-Mental-Processes)
    ...
    - [Section: Attentional control and executive functions](#Section:-Attentional-control-and-executive-functions)
      - [Backward Inhibition and Attentional Control](#Backward-Inhibition-and-Attentional-Control)
  ...
  - [Chapter: Frontal Lobe Functions](#Chapter:-Frontal-Lobe-Functions)
    ...
    - [Social cognition and theory of mind](#Social-cognition-and-theory-of-mind)
      ...
      - [Social Schemas and Network Perception](#Social-Schemas-and-Network-Perception)
  ...
  - [Chapter: Cognition in Alzheimer’s Disease](#Chapter:-Cognition-in-Alzheimer’s-Disease)
    ...
    - [Memory impairments and recognition deficits in AD](#Memory-impairments-and-recognition-deficits-in-AD)
...
In a study by Bertamini, Friedenberg, and Kubovy (1997), it was found that participants were quicker and more accurate at detecting symmetrical patterns compared to asymmetrical ones. This suggests that symmetry detection is an automatic and fundamental process in perceptual organization.
...
Both novelty detection and surprise responses play a crucial role in learning and memory. Novel stimuli and unexpected events grab our attention and enhance memory encoding, making it more likely that we will remember these events in the future (Tulving, Markowitsch, Craik, Habib, & Houle, 1996).
...
In addition to the prefrontal cortex, other brain regions are also involved in working memory. For instance, the parietal cortex is implicated in the storage of spatial information, while the hippocampus is involved in the binding of disparate pieces of information into a coherent whole (Eriksson et al., 2015).
...
One key inhibitory process is backward inhibition, a phenomenon in which the activation of a current task leads to the inhibition of previously activated tasks. This process is thought to facilitate task-switching by reducing interference from previous tasks (Mayr & Keele, 2000).
...
In this chapter, we will unravel the complex relationship between audition and music, providing a comprehensive understanding of how our brains process and interpret the sounds that fill our world.
...
The primary auditory cortex, located in the superior temporal gyrus, is the first cortical structure to process incoming auditory information. This region is organized tonotopically, similar to the organization of the cochlea, with different areas responding to different frequencies. 
...
We begin by exploring the role of hormones in cognition and brain plasticity. Hormones, the body's chemical messengers, have a profound impact on the brain's structure and function. They influence our thoughts, feelings, and behaviors, and play a crucial role in brain plasticity. This section will provide an overview of the latest research on hormonal influences on cognition and brain plasticity.
...
REM sleep, characterized by rapid eye movements, increased brain activity, and vivid dreams, has long been associated with memory consolidation[^2^]. During REM sleep, neuronal activity increases following an enriched or novel waking experience, enhancing neuronal plasticity and thus playing a crucial role in the consolidation of memories[^2^].

However, this association has been questioned in recent years. Studies on sleep deprivation have shown that animals and humans deprived of REM sleep do not show deficits in task learning[^2^]. This has led to the proposal that since the brain is in a non-memory encoding state during sleep, consolidation would be unlikely to occur during this time[^2^].

#### Slow-Wave Sleep and Memory Consolidation

More recent studies have shifted focus to the role of slow-wave sleep in memory consolidation. Slow-wave sleep, the deepest stage of non-REM sleep, is characterized by slow, high-amplitude brain waves[^2^]. 

One study found that low levels of acetylcholine, a neurotransmitter found in the central nervous system, are present during slow-wave sleep and aid in the consolidation of memories[^2^]. This suggests that slow-wave sleep may assist in the learning process by facilitating memory consolidation[^2^].

#### Procedural Learning and Sleep

Recent studies have also examined the relationship between REM sleep and procedural learning consolidation, particularly in relation to sensory and motor tasks[^2^]. In one study, participants were split into two groups and tested post-training with or without intervening sleep[^2^]. The results showed that sleep post-training increased both speed and accuracy in a finger-tapping task, while also increasing the activation of cortical and hippocampal regions[^2^]. 

This suggests that sleep may facilitate synaptic consolidation, a process that strengthens the synaptic connections that form memories[^2^]. However, it's important to note that this process is short-term and differs from systems consolidation, which involves the reorganization of memory traces across different brain regions over a longer period[^2^].

In conclusion, while the exact mechanisms of sleep and memory consolidation are still being explored, it is clear that sleep plays a crucial role in this process. Further research is needed to fully understand the complex interplay between different stages of sleep and various types of memory consolidation.
...
Neuroplasticity, also known as brain plasticity, refers to the ability of the brain to change and adapt in response to experience, learning, and injury[^3^]. This plasticity is a fundamental property of the nervous system and is critical for normal brain function, learning, memory, and recovery from brain damage[^3^].

#### Neuroplasticity in Neurorehabilitation

Neurorehabilitation leverages the concept of neuroplasticity to help patients recover from neurological injury. The goal of neurorehabilitation is to maximize the patient's functional independence and quality of life by enhancing their residual neurological function, teaching compensatory strategies, and facilitating social reintegration[^4^].
...
Through the use of neuroimaging methods, we have been able to gain unprecedented insights into the workings of the human brain. Techniques such as fMRI and PET scans have allowed us to visualize the brain in action, providing invaluable data for cognitive neuroscience research.
...
#### Amyloid-beta (Aβ) plaques and cognitive decline
...
Jacoby's study (1999) demonstrated how common these errors can become in AD. Similarly, Cohen and Faulkner's study (1989) showed that elderly subjects were more likely to claim that they recognized events that never happened. These studies suggest that recognition deficits in AD are not just a result of memory loss, but also a failure in the cognitive processes involved in recognition.
